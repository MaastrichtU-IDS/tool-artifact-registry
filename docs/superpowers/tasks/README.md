...
| 03 | [Peer stub retention, and caching only a stub](03-peer-stub-retention.md) | Needs design · **decided** | spec Q3, limitations #7 |
| 04 | [Repository liveness metrics](04-repo-liveness-metrics.md) | Needs design · **done** on `repo-liveness` | limitations #4, handoff §9 |
